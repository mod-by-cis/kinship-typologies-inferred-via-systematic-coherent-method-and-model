    ...
    const mathCalcs = [
      ...
      },
      {
        ...
        val: (currentM) => {
          ...
          testSomNotOfValsArray("i", i__Array, "isNotValNaturalPos");
          return i__Array.map(
            (val_i, _index) => pow2Affine(1, 1, -1, val_i, val2Adic)
          );
        }
      },
      {
        ...
        val: (currentM) => {
          ...
          testSomNotOfValsArray("j", j__Array, "isNotValNaturalPos");
          return j__Array.map(
            (val_j, _index) => pow2Affine(1, 1, -1, val_j, val2Adic)
          );
        }
      },
      {
